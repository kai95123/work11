...
<?php if ($tempera_tables == "Enable") { ?>
		.entry-content table {border:none;} .entry-content tr { background: none; } .entry-content table { border:none; }
		.entry-content tr th, .entry-content thead th { background:none; } .entry-content tr th, .entry-content tr td { border:none; }
<?php } ?>
...
.entry-content p, .entry-content ul, .entry-content ol, .entry-content dd, .entry-content pre, .entry-content hr { margin-bottom: <?php echo $tempera_paragraphspace;?>; }
